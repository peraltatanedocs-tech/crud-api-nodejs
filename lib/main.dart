...
// ATTENDANCE LIST PAGE - View all records
...
// Home Page - with Navigation Rail + Responsive Layout
...
class _HomePageState extends State<HomePage> {
  AppSection _current = AppSection.timeIn;
  ...
  Widget build(BuildContext context) {
    ...
    final side = NavigationRail(
      ...
      destinations: const [
        ...
        NavigationRailDestination(icon: Icon(Icons.list), label: Text('Attendance')),
      ],
    );
